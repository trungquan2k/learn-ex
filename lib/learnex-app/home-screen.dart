        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(20*fem, 9.45*fem, 20*fem, 226*fem),
              width: double.infinity,
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(131*fem, 98.5*fem, 107*fem, 7.5*fem),
                    width: double.infinity,
                    decoration: BoxDecoration (
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 98*fem, 0*fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 140*fem, 11*fem),
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 13*fem, 13*fem),
                            padding: EdgeInsets.fromLTRB(0*fem, 11*fem, 4.28*fem, 9*fem),
                            width: double.infinity,
                            height: 118*fem,
                            decoration: BoxDecoration (
                              color: Color(0xffffffff),
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 9.63*fem, 0*fem),
                                  width: 152.1*fem,
                                  height: 98*fem,
                                  child: Image.asset(
                                  ...
                                  child: Stack(
                                    children: [
                                      ...
                                      Positioned(
                                        ...
                                        top: 36*fem,
                                        child: Container(
                                          padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 59.77*fem, 0*fem),
                                          width: 168.46*fem,
                                          height: 28*fem,
                                          decoration: BoxDecoration (
                                            color: Color(0xffffffff),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 7.7*fem, 0*fem),
                                                width: 25.99*fem,
                                                height: 28*fem,
                                                child: Image.asset(
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 13*fem, 13*fem),
                            padding: EdgeInsets.fromLTRB(0*fem, 11*fem, 4.81*fem, 9*fem),
                            width: double.infinity,
                            height: 118*fem,
                            decoration: BoxDecoration (
                              color: Color(0xffffffff),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0.46*fem, 4*fem),
                                        constraints: BoxConstraints (
                                          maxWidth: 168*fem,
                                        ),
                                        child: Text(
                                      ...
                                      Container(
                                        ...
                                        padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 23.77*fem, 0*fem),
                                        width: double.infinity,
                                        decoration: BoxDecoration (
                                          color: Color(0xffffffff),
                                          borderRadius: BorderRadius.circular(6*fem),
